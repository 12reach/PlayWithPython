...
def main():
    ...
    print(ManaName, "has height of", mana.variables['height'], "and her shool's name is", mana.variables['school'])
    ...
    print(BabuName, "he is a student of", babu.variables['student_of'], "and he reads at",
          babu.variables['reads_at'], "and his height is", babu.variables['height'])
